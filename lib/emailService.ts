        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${process.env.NEXTAUTH_URL}/dashboard/leaves" class="btn">Review Leave Request</a>
            </div>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${process.env.NEXTAUTH_URL}/dashboard/payroll" class="btn">View Payslip</a>
              <a href="${process.env.NEXTAUTH_URL}/dashboard/payroll/download/${payroll._id}" class="btn">Download Payslip</a>
            </div>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${process.env.NEXTAUTH_URL}/dashboard/payroll/approve" class="btn">Review & Approve Payroll</a>
            </div>

    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ₹{records.length > 0 ? records[0].netSalary.toFixed(0) : "0"}
            </div>
            <p className="text-xs text-muted-foreground">
              {records.length > 0 ? formatMonth(records[0].month) : "No records"}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ₹{records.length > 0 ? (records.reduce((sum, r) => sum + r.netSalary, 0) / records.length).toFixed(0) : "0"}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">
              ₹{(records.reduce((sum, r) => sum + r.netSalary, 0)).toFixed(0)}
            </div>
            <p className="text-xs text-muted-foreground">Cumulative net salary</p>
          </CardContent>
        </Card>
      </div>
